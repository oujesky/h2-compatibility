...
class JsonInsertTest {
    ...
    void testJsonInsert(String json, String values, String expected) throws SQLException {
        verifyQuery(
            String.format("SELECT JSON_INSERT(?, %s)", values),
